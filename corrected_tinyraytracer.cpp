...
Model duck("C:/Users/25498/Desktop/tryin_raytracing/tryin/duck.obj");            // 加载鸭子3D模型文件（位于上一级目录）
...
void render(const std::vector<Sphere> &spheres, const std::vector<Light> &lights) {
    ...
    // 将图像保存为JPEG文件，质量为100
    stbi_write_jpg("output/out_corrected.jpg", width, height, 3, pixmap.data(), 100);
}
...
int main() {
    ...
    unsigned char *pixmap = stbi_load("../beach.jpg", &envmap_width, &envmap_height, &n, 0);
